defmodule KddNotionEx.Templates do
  ...
  def date_prop(key, %DateTime{} = value) do
    %{
      key => %{
        type: "date",
        date: %{
  ...
  def date_prop(key, {%Date{} = value, nil}) do
    %{
      key => %{
        type: "date",
        date: %{
  ...
  def date_prop(key, %Date{} = value) do
    %{
      key => %{
        type: "date",
        date: %{
  ...
  def relation_prop(key, value) when is_binary(value) do
    %{
      key => %{
        type: "relation",
        relation: [%{
